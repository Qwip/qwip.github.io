...
class Main():
    def __init__(self):
        ...
        self.stations[0][1] = 0
        self.stations[0][2] = 0
        self.stations[1][0] = 500#1500#0
        self.stations[1][1] = 1000#3000#0
        self.stations[1][2] = 0#0#500#
        self.stations[2][0] = 1000
        self.stations[2][1] = 0
        self.stations[2][2] = 0
        self.stations[3][0] = 1500#1000
        ...
        self.stations[5][0] = 2500#450#0#-1000
        self.stations[5][1] = 1000#2000#1000
        self.stations[5][2] = 0#0#500#1000
        self.stations[6][0] = 3000#2000 #-1000
        self.stations[6][1] = 0#2000#0
        self.stations[6][2] = 0#0
        self.stations[7][0] = 3500#-1000
        self.stations[7][1] = 1000#-1000
        self.stations[7][2] = 0#1000
        self.stations[8][0] = 4000#2000#1000#0
        self.stations[8][1] = 0#6000#0#1000#-1000
        self.stations[8][2] = 0#0
        self.stations[9][0] = 4500#3000#1000#1000
        self.stations[9][1] = 1000#3000#1000#-1000
        self.stations[9][2] = 0#450#1000
        self.stations[10][0] = 5000
        self.stations[10][1] = 0
        self.stations[10][2] = 1000
        '''
